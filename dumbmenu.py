...
# Function "dumbmenu" **************************************************
# **********************************************************************
def dumbmenu(screen, menu, x_pos = 100, y_pos = 100, size = 70,
			distance = 1.4, fgcolor = (255,255,255), bgcolor = (0,0,0),
			cursorcolor = (255,0,0), exitAllowed = True):
	"""Draws a Menu using pygame.
	
	Parameters are: screen, menu, x_pos, y_pos, size, distance, fgcolor,
	                bgcolor, cursor
	...
	bgcolor (Tupel): Background-Color, means the "filling" color which
	                 removes an older cursor-position
	                 (Default: (0,0,0), means black)
	...
	print dumbmenu(screen, [
	                        ...
	                        'Manual',
	                        'Show Highscore',
	                        'Quit Game'], 320,250,32,1.4,green,blue,red)
	...
	speaker) and the sourcecode isn't that good too. It's more or less
	a "quick'n dirty"-Solution. My only intention was to make that code
	for me, but I thought it could may helpful for other people too...
	...
	while True:
		...
		if ArrowPressed == True:
			screen.fill(bgcolor, cursorrect)
